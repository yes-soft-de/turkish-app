 ...
 */
final class Version20201129155325 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE car_entity (id INT AUTO_INCREMENT NOT NULL, brand VARCHAR(255) NOT NULL, company VARCHAR(255) NOT NULL, year_of_release DATE DEFAULT NULL, engine VARCHAR(255) NOT NULL, price INT DEFAULT NULL, description LONGTEXT DEFAULT NULL, status VARCHAR(255) NOT NULL, created_by VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, update_at DATETIME DEFAULT NULL, distance VARCHAR(255) NOT NULL, car_type VARCHAR(50) NOT NULL, gear_type VARCHAR(50) NOT NULL, cc VARCHAR(50) NOT NULL, fuel VARCHAR(50) NOT NULL, country VARCHAR(100) NOT NULL, city VARCHAR(100) NOT NULL, image VARCHAR(255) NOT NULL, special_link TINYINT(1) DEFAULT NULL, state VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE device_entity (id INT AUTO_INCREMENT NOT NULL, brand VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, cpu VARCHAR(255) NOT NULL, ram VARCHAR(255) NOT NULL, battery VARCHAR(255) NOT NULL, price INT NOT NULL, year_of_release DATE DEFAULT NULL, description LONGTEXT DEFAULT NULL, status VARCHAR(255) NOT NULL, created_by VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT NULL, update_at DATETIME DEFAULT NULL, gauge VARCHAR(255) NOT NULL, country VARCHAR(100) NOT NULL, city VARCHAR(100) NOT NULL, duration_of_use VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, special_link TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE document_entity (id INT AUTO_INCREMENT NOT NULL, image VARCHAR(255) NOT NULL, entity VARCHAR(255) NOT NULL, item_id INT NOT NULL, special_link TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE real_estate_entity (id INT AUTO_INCREMENT NOT NULL, country VARCHAR(100) NOT NULL, city VARCHAR(100) NOT NULL, space VARCHAR(255) NOT NULL, price INT NOT NULL, description LONGTEXT DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, created_by VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT NULL, update_at DATETIME DEFAULT NULL, state VARCHAR(255) DEFAULT NULL, image VARCHAR(255) NOT NULL, special_link TINYINT(1) DEFAULT NULL, number_of_floors VARCHAR(50) NOT NULL, cladding VARCHAR(255) NOT NULL, home_furnishing VARCHAR(50) NOT NULL, real_estate_type VARCHAR(50) NOT NULL, rooms VARCHAR(50) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
