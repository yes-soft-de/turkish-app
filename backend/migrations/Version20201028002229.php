 ...
 */
final class Version20201028002229 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE car_entity (id INT AUTO_INCREMENT NOT NULL, brand VARCHAR(255) NOT NULL, company VARCHAR(255) NOT NULL, year_of_release DATE DEFAULT NULL, engine VARCHAR(255) NOT NULL, price INT DEFAULT NULL, description LONGTEXT DEFAULT NULL, status VARCHAR(255) NOT NULL, created_by VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, distance VARCHAR(255) NOT NULL, car_type VARCHAR(50) NOT NULL, gear_type VARCHAR(50) NOT NULL, cc VARCHAR(50) NOT NULL, fuel VARCHAR(50) NOT NULL, location VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE device_entity (id INT AUTO_INCREMENT NOT NULL, brand VARCHAR(255) NOT NULL, cpu VARCHAR(255) NOT NULL, ram VARCHAR(255) NOT NULL, battery VARCHAR(255) NOT NULL, price INT NOT NULL, year_of_release DATE DEFAULT NULL, description LONGTEXT DEFAULT NULL, status VARCHAR(255) NOT NULL, created_by VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, gauge VARCHAR(255) NOT NULL, location VARCHAR(255) NOT NULL, duration_of_use VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE image_entity (id INT AUTO_INCREMENT NOT NULL, image VARCHAR(255) NOT NULL, entity VARCHAR(50) NOT NULL, item_id INT NOT NULL, special_link TINYINT(1) DEFAULT NULL, main_image TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE status_entity (id INT AUTO_INCREMENT NOT NULL, user_id VARCHAR(255) NOT NULL, lawyer_id VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, created_by VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
