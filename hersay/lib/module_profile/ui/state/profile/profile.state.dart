...
class ProfileStateLoading extends ProfileState {
  ProfileStateLoading(ProfileScreenState screenState) : super(screenState);
...
class ProfileStateUnauthorized extends ProfileState {
  ProfileStateUnauthorized(ProfileScreenState screenState) : super(screenState);
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.pushNamed(
                                context, ProfileRoutes.EDIT_PROFILE_SCREEN,
...
//                  padding: EdgeInsets.symmetric(horizontal: 8, vertical: 8),
        ...
        child: ChoiceChip(
          ...
          onSelected: (selected) {
            if (selected) {
              ...
              getCategoriesPosts(profileData.services, selectChoice);
            } else {
              selectChoice = null;
              displayedProducts = profileData.services;
            }
   ...
   getCategoriesPosts(List<ProfileElement> services, int id) {
    List<ProfileElement> filtred = [];
